...
public class Marrio extends ApplicationAdapter {
	SpriteBatch batch;
	Texture background;
	Texture[] man;
	int manState;
	...
	public void render () {
		...
		if (gameState == 1) {
			...
			for (int i=0;i < bombXs.size(); i++){
				...
				bombRectangle.add(new Rectangle(bombXs.get(i), bombYs.get(i), bomb.getHeight(), bomb.getHeight()));
			...
			for (int i=0;i < coinXs.size(); i++){
				...
				coinsRectangle.add(new Rectangle(coinXs.get(i), coinYs.get(i), coin.getHeight(), coin.getHeight()));
			}
